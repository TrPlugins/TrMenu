 ...
 *
 * @param windowId The window which is being updated. 0 for player inventory.
 ...
 *
 */
class PacketWindowSetSlot(val windowId: Int = 119, val slot: Int, val itemStack: ItemStack? = null) : PacketInventory