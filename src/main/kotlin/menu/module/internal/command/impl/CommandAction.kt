        ...
        dynamic {
            ...
            dynamic {
                execute<CommandSender> { sender, context, argument ->
                    ...
                    val (hidePrint, action) = argument.startsWith("#") to menu.api.action.Actions.readAction(argument.removePrefix("#"))

                    measureNanoTime {
                        menu.api.action.Actions.runAction(player, action).let {
