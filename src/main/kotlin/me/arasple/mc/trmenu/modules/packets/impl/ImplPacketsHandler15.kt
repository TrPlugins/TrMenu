 ...
 * @date 2020/3/5 19:41
 */
class ImplPacketsHandler15 : PacketsHandler() {

	override fun sendOpenWindow(player: Player, windowId: Int, inventoryType: InventoryType, size: Int, inventoryTitle: String) =
		sendPacket(player, PacketPlayOutOpenWindow::class.java, PacketPlayOutOpenWindow(), mapOf(Pair("a", windowId), Pair("b", getInventoryType(inventoryType, size)), Pair("c", ChatComponentText(inventoryTitle))))
