...
) = cc.trixey.mc.invero.impl.container.util.dsl.scroll(scale, pos, weight, block).also { add(it) }
...
) = cc.trixey.mc.invero.impl.container.util.dsl.standard(scale, pos, weight, block).also { add(it) }
...
) = cc.trixey.mc.invero.impl.container.util.dsl.paged(scale, pos, weight, block).also { add(it) }
...
) = cc.trixey.mc.invero.impl.container.util.dsl.pagedNetesed(scale, pos, weight, block).also { add(it) }
...
) = cc.trixey.mc.invero.impl.container.util.dsl.generatorScroll(scale, pos, weight, block).also { add(it) }
...
) = cc.trixey.mc.invero.impl.container.util.dsl.generatorPaged(scale, pos, weight, block).also { add(it) }
...
) = cc.trixey.mc.invero.impl.container.util.dsl.storageIOPanel(scale, pos, weight, block).also { add(it) }
...
) = cc.trixey.mc.invero.impl.container.util.dsl.freeformNetesed(scale, pos, weight, block).also { add(it) }
