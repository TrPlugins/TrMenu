...
/**
 * TrMenu
 * trplugins.menu.api.action.impl.metadaa.SetGlobalData
 *
 * @author Score2
 * @since 2022/02/14 14:28
 */
class SetGlobalData(handle: ActionHandle) : ActionBase(handle) {

    override val regex = "set-?(global|g)-?datas?".toRegex()
