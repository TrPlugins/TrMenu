package menu.module.internal.script.impl

import trmenu.module.internal.data.Metadata
import trmenu.module.internal.script.kether.BaseAction
import trmenu.module.internal.script.kether.EditType
import trmenu.module.internal.script.kether.EditType.*
...
class KetherData(val type: EditType, private val source: ParsedAction<*>, private val apply: ParsedAction<*>?) :
    ...
    companion object {
        ...
        @KetherParser(["data"], namespace = "tr" + "menu")
